...
appreciated!  pySpyEPI is a community-driven project and welcomes both feedback
and contributions.
...
* Submit bug reports, feature requests, and questions at
  [GitHub](https://github.com/alanahco/pySpyEPI/issues)
...
When [reporting a bug](https://github.com/alanahco/pySpyEPI/issues)
please include:
...
[issue](https://github.com/alanahco/pySpyEPI/issues).
...
To set up `pySpyEPI` for local development:

1. [Fork pySpyEPI on
    GitHub](https://github.com/alanahco/pySpyEPI/fork).

2. Clone your fork locally:

  ```
    git clone git@github.com:your_name_here/pySpyEPI.git
  ```
...
5. You should also check for flake8 style compliance:
   ...
   Note that pySpyEPI tests for uniformity in docstring formatting.
...
7. Add your name, affiliation, and ORCiD to the CITATION.cff file as an author
...
8. Commit your changes:
   ...
   `pySpyEPI` follows the [numpy development workflow](https://numpy.org/doc/stable/dev/development_workflow.html),
...
3. Update the author list in ``CITATION.cff``, if applicable
4. Ensure that all checks passed (e.g., GitHub Actions, Coveralls,
   and ReadTheDocs)
...
In general, pySpyEPI follows PEP8 and numpydoc guidelines. unittest runs the
unit and integration tests, flake8 checks for style, and sphinx-build
...
* The pySpyEPI logger is imported into each sub-module and provides
